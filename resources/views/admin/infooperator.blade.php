                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                            <input id="email" type="email" class="form-control" name="email" value="{{$op->Email}}">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        @else
                                            ...
                                            <div class="col-md-6">
                                            <input id="idgedung" type="text" class="form-control" name="idgedung" value="Gedung Belum Terdaftar" readonly>          
                                            </div>
                                            @endif
                                    ...
                                    <div class="form-group row mb-0">
                                            <div class="col-md-6 offset-md-4">
                                                ...
                                                @foreach($gedung as $g)
                                                @if(count($gedung) == 0)
                                                    <a href="/gedung/{{$op->Email}}/tambah" class="btn btn-primary">Tambah Gedung</a>
                                                @endif
                                                @endforeach
                                                </form>
                                            </div>
