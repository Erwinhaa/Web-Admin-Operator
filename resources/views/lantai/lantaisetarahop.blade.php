...
<form action="/lantaisetarahop/tambah" method="post">
    {{ csrf_field() }}
  <div class="isi">
      <h2>Choose Slot To Add Arah</h2>
      ...
      <!--Cetak Slot Lantai -->
          ...
          @elseif($sub->Status_Slot == 2)<div class="kotak1">{{$sub->Nama_Slot}}</div>
      ...
      @endif    
          ...
          <div class="qma">
            ...
            <select name="status_slot">
                <option value="11">Arah Atas</option>
                <option value="12">Arah Kiri</option> 
                <option value="13">Arah Kanan</option>
                <option value="14">Arah Bawah</option>
            </select>
              <input type="hidden" name="lid" value="{{$l->id}}">
              <input type="hidden" name="jl" value="{{$l->Jumlah_Slot}}">
            </br></br>
            Arah Atas : <img src="/images/arahatas.png" width="50px" height="50px">   
            </br></br>
            Arah Kiri : <img src="/images/arahkiri.png" width="50px" height="50px">   
            </br></br>
            Arah Kanan : <img src="/images/arahkanan.png" width="50px" height="50px">   
            </br></br>
            Arah Bawah : <img src="/images/arahbawah.png" width="50px" height="50px">   
