...
<div class="isi">       
    <!--Cetak Slot Lantai -->
        ...
        <div class="bawah">
                <div class="menee">
                    <a href="/opslot/{{$l->id}}/add" class="btn btn-primary">Add Slot</a>
                    <a href="#delete10" data-toggle="modal" class="btn btn-danger">Delete Slot</a>
                </div>
                <div class="menee1">            
                    <a href="/oplantaitest/{{$l->id}}" class="btn btn-primary">Slot Easy</a>
                    <a href="/oplantaitestdelete/{{$l->id}}" class="btn btn-danger">Delete Slot Easy</a>
                </div>
                @include('inc.modal2')
        </div>         
